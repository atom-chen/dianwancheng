...
class JinShaInfo {
    ...
    private _zhuangLists: Array<any>;
    private _isZhuang: boolean = false;
    private _numShengyu: number = 0;
    ...
    public get zhuangLists(): Array<any> {
        return this._zhuangLists;
    }

    public set zhuangLists(value: Array<any>) {
    ...
    public get numShengyu(): number {
        return this._numShengyu;
    }

    public set numShengyu(value: number) {

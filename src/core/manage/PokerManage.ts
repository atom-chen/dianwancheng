...
module PokerManage{
    ...
    export function paixu(arr,pokerArr): Array<any> {
        pokerArr = pokerArr||[];
        var lenn = arr.length;
    ...
    export function chupai(chus: Array<any>,pokers: Array<any>): void {
        var len = chus.length;
    ...
    export function chupai2(chus: Array<any>,pokers: Array<any>): void {
        var len = chus.length;
        var lenn = pokers.length;
        for(var i = 0;i < len;i++) {
            for(var j = 0;j < lenn;j++) {
    ...
    export function jia3zhang(jias: Array<any>,pokers: Array<any>): void {
        var len = jias.length;
        var lenn = pokers.length;
        for(var i = 0;i < len;i++) {
            for(var j = 0;j < lenn;j++) {

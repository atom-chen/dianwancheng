 ...
 * 增加静默加载机制
 */
module ResourceManage {
    export var _configs:Array<any>;
    export var _onConfigComplete:Function;
    export var _onConfigCompleteTarget:any;

    export var _groups:any;
    export var _groupIndex:number = 0;
     ...
     */
    export function addConfig(jsonPath:string, filePath:string):void {
     ...
     */
    export function loadConfig($onConfigComplete:Function, $onConfigCompleteTarget:any):void {
     ...
     * 加载
     */
    export function loadNextConfig():void {
        //加载完成
     ...
     * @param event
     */
    export function onConfigCompleteHandle(event:RES.ResourceEvent):void {
     ...
     */
    export function loadGroup($groupName:string, $onResourceLoadComplete:Function, $onResourceLoadProgress:Function, $onResourceLoadTarget:any):void {
     ...
     * @param $onResourceLoadTarget 资源加载监听函数所属对象
     */
    export function loadGroups($groupName:string, $subGroups:Array<any>, $onResourceLoadComplete:Function, $onResourceLoadProgress:Function, $onResourceLoadTarget:any):void {
     ...
     */
    export function pilfererLoadGroup($groupName:string, $subGroups:Array<any> = null):void {
        //添加前缀，防止与正常加载组名重复
     ...
     * 资源组加载进度
     */
    export function onResourceLoadProgress(event:RES.ResourceEvent):void {
        var groupName:string = event.groupName;
        if (this._groups[groupName]) {
     ...
     * @param $onResourceLoadTarget 资源加载监听函数所属对象
     */
    export function loadResource($resources = [], $groups = [], $onResourceLoadComplete:Function = null, $onResourceLoadProgress:Function = null, $onResourceLoadTarget:any = null):void {

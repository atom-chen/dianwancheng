...
module TipsUtils {
    ...
    //从下到上弹出
    export function showTipsDownToUp(str: string = "",isWarning: boolean = true): void {
        ...
        if(!PanelManage.tipsLayer.contains(effectTips)) {
            PanelManage.tipsLayer.addChild(effectTips);
        }

        var onComplete2: Function = function() {
            if(PanelManage.tipsLayer.contains(effectTips)) {
                PanelManage.tipsLayer.removeChild(effectTips);
                effectTips = null;
            }
        };

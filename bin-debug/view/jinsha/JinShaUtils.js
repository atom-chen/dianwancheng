 ...
 * All Rights Reserved.
 */
var JinShaUtils = (function () {
    function JinShaUtils() {
        if (JinShaUtils.instance) {
            throw new Error("Instance is alreally exist");
        }
        this.jinsha = new JinShaInfo();
    }
    JinShaUtils.getInstance = function () {
        if (this.instance == null) {
            this.instance = new JinShaUtils();
        }
        return this.instance;
    };
    JinShaUtils.prototype.clear = function () {
        this.jinsha = null;
    };
    JinShaUtils.prototype.startEffect = function () {
    ...
    JinShaUtils.prototype.initZhuangList = function () {
    ...
    JinShaUtils.prototype.getJinSha = function () {
        if (this.jinsha == null) {
            this.jinsha = new JinShaInfo();
        }
        return this.jinsha;
    };
    JinShaUtils.prototype.setZhuangItem = function (item) {
        this.jinsha.zhuangLists.push(item);
    };
    JinShaUtils.prototype.isCanQuit = function () {
    ...
    JinShaUtils.prototype.manageMc = function (jiesuan, pushArr) {
        if (this.jinsha.isGo) {
    ...
    JinShaUtils.prototype.fuyuan = function () {
    ...
    JinShaUtils.prototype.getDanZhu = function (danzhu) {
        var dz = 0;
        switch (danzhu) {
            case "1000":
                dz = 10000;
    ...
    JinShaUtils.prototype.jiesuan = function (arr, result) {
        var len = arr.length;
        var win = 0;
        for (var i = 0; i < len; i++) {
    ...
    JinShaUtils.prototype.getBet = function (num) {
        var bet = 1;
        switch (num) {
            case 1:
                bet = 2;
    ...
    JinShaUtils.prototype.getTrueRes = function (result) {
        var stt = "";
        var end = 0;
        switch (result) {
            case "2":
...
JinShaUtils.instance = null;
__reflect(JinShaUtils.prototype, "JinShaUtils");

...
var ZhaJinHuaPanel = (function (_super) {
    __extends(ZhaJinHuaPanel, _super);
    function ZhaJinHuaPanel(r) {
        ...
        //============================================红包
        _this.redPanel = null;
        _this.skinName = "resource/skins/ZhaJinHuaSkin.exml";
        _this.r = r;
        return _this;
    }
    // private testNum: number = 0;
    ZhaJinHuaPanel.prototype.childrenCreated = function () {
    ...
    ZhaJinHuaPanel.prototype.initData = function () {
    ...
    //获取原始扑克的位置
    ZhaJinHuaPanel.prototype.getOrginCardPos = function () {
        for (var i = 0; i < 3; i++) {
    ...
    ZhaJinHuaPanel.prototype.addEvent = function () {
    ...
    //设置顶部自身数据
    ZhaJinHuaPanel.prototype.setSelfInfo = function () {
    ...
    //设置彩金
    ZhaJinHuaPanel.prototype.setHandsel = function (num) {
        this.labHandsel.text = QuickManage.moneyStr(num);
    };
    ZhaJinHuaPanel.prototype.setTips = function () {
        this.labTips.text = '';
    };
    ZhaJinHuaPanel.prototype.setCountdown = function () {
        this.cdTimer = new egret.Timer(1000);
        this.cdTimer.addEventListener(egret.TimerEvent.TIMER, this.clacTimer, this);
    };
    ZhaJinHuaPanel.prototype.clacTimer = function () {
        if (this.cdNum % 7 == 0) {
            this.getBets();
        }
        if (this.cdNum > 0) {
    ...
    ZhaJinHuaPanel.prototype.joinCallback = function (msg) {
        if (msg.code == 200) {
    ...
    ZhaJinHuaPanel.prototype.onMsgListen = function (data) {
        var msg = data.msg;
    ...
    //获取结算数据，显示结果面板时设置
    ZhaJinHuaPanel.prototype.setGameResult = function (data) {
        this.grpCountdown.visible = false;
        this.cardResult = data;
        var poke = data.pokes;
    };
    //同步座位
    ZhaJinHuaPanel.prototype.updataSeat = function (type, data) {
        if (type == 1) {
    ...
    //同步彩金 （包含庄结算输赢）
    ZhaJinHuaPanel.prototype.updateHandsel = function (data) {
    ...
    //同步庄的顺位
    ZhaJinHuaPanel.prototype.updateBankerRank = function (data) {
    ...
    //获取上庄列表
    ZhaJinHuaPanel.prototype.getBankerList = function (e) {
    ...
    //上庄列表
    ZhaJinHuaPanel.prototype.bankerListCallback = function (msg) {
        if (msg.code == 200) {
    ...
    ZhaJinHuaPanel.prototype.onTouchCloseBankerList = function () {
        this.grpBankerList.visible = false;
    };
    //同步下注消息
    ZhaJinHuaPanel.prototype.getBets = function () {
        Net.send(Protocol.GOLDEN_GET_BETS, {}, this.getBetsCallback.bind(this));
    };
    //定时同步下注筹码
    ZhaJinHuaPanel.prototype.getBetsCallback = function (msg) {
        if (msg.code == 200) {
            var list = msg.list;
            for (var i = 1; i < 5; i++) {
                if (list[i].score != 0) {
    ...
    //离开游戏判断
    ZhaJinHuaPanel.prototype.onTouchClose = function () {
        if (this.isBanker) {
    ...
    //充值
    ZhaJinHuaPanel.prototype.onTouchCharge = function () {
        PanelManage.openShop(3);
    };
    //充值返回
    ZhaJinHuaPanel.prototype.updatePayData = function (data) {
        GlobalData.user.gold = data.param.msg.gold;
        lcp.LListener.getInstance().dispatchEvent(new lcp.LEvent(EventData.UPDATE_MAIN));
        this.labTitleVip.text = 'v' + GlobalData.user.vip;
    };
    //上庄
    ZhaJinHuaPanel.prototype.onTouchUpBank = function () {
    ...
    //上庄回调
    ZhaJinHuaPanel.prototype.upBankerCallback = function (msg) {
        if (msg.code == 200) {
    ...
    //下庄
    ZhaJinHuaPanel.prototype.onTouchDownBank = function () {
        Net.send(Protocol.GOLDEN_DOWN_BANKER, {}, this.downBankerCallback.bind(this));
    };
    //下庄回调
    ZhaJinHuaPanel.prototype.downBankerCallback = function (msg) {
        if (msg.code == 200) {
    ...
    //vip 座位
    ZhaJinHuaPanel.prototype.onTouchSeat = function (index) {
        if (this.isBanker) {
    ...
    //筹码选择
    ZhaJinHuaPanel.prototype.onTouchBet = function (index) {
        if (this.isBanker) {
    ...
    ZhaJinHuaPanel.prototype.onTouchSelectIndex = function (index) {
    ...
    //下注
    ZhaJinHuaPanel.prototype.betGlodCallback = function (msg) {
    ...
    //设置庄家的消息
    ZhaJinHuaPanel.prototype.setBankerInfo = function (banker) {
        if (banker.sys == 1) {
    ...
    //设置开奖记录
    ZhaJinHuaPanel.prototype.setHistory = function () {
        for (var i = 0; i < 10; i++) {
    ...
    ZhaJinHuaPanel.prototype.updateGold = function () {
        Net.send(Protocol.JINHUA_GET_GOLD, {}, this.getGoldCallback.bind(this));
    };
    ZhaJinHuaPanel.prototype.getGoldCallback = function (data) {
        if (data.code == 200) {
    ...
    ZhaJinHuaPanel.prototype.showGameTips = function (type) {
    ...
    //显示筹码
    ZhaJinHuaPanel.prototype.showCoins = function (num, index) {
        var isRemove = false;
        MusicManage.playMuisc(JinHuaUtil.getInstance().getSoundEffect(8), 0.5);
        var point = JinHuaUtil.getInstance().getCoinsPos(index);
    ...
    ZhaJinHuaPanel.prototype.cardEffect = function () {
        this.isCardEffectShow = true;
        this.flyIntval = setInterval(this.playCardFly.bind(this), 200);
    };
    ZhaJinHuaPanel.prototype.playCardFly = function () {
    ...
    ZhaJinHuaPanel.prototype.bankerCardFly = function () {
    ...
    ZhaJinHuaPanel.prototype.playerCardRotation = function () {
    ...
    ZhaJinHuaPanel.prototype.bankerCardRotation = function () {
        MusicManage.playMuisc(JinHuaUtil.getInstance().getSoundEffect(7));
    ...
    ZhaJinHuaPanel.prototype.blinkEffect = function () {
        clearInterval(this.interval);
    ...
    ZhaJinHuaPanel.prototype.cardEffectEnd = function () {
        clearInterval(this.interval);
    ...
    //============================================  Game Result
    ZhaJinHuaPanel.prototype.showGameResult = function () {
        clearInterval(this.interval);
    ...
    ZhaJinHuaPanel.prototype.boomShow = function () {
        this.grpCaijin.visible = false;
        this.imgBaoZhuang.visible = true;
        clearInterval(this.interval);
        this.interval = setInterval(this.setStartBet.bind(this), 4000);
    };
    ZhaJinHuaPanel.prototype.caijinShow = function (msg) {
    ...
    ZhaJinHuaPanel.prototype.setStartBet = function () {
        this.resetGame();
        this.grpResult.visible = false;
        clearInterval(this.interval);
        this.showGameTips(2);
    ...
    ZhaJinHuaPanel.prototype.resetGame = function () {
        for (var i = 0; i < 4; i++) {
            this['labBetsPool' + i].text = '0';
            this['labBetsSelf' + i].text = '0';
    ...
    ZhaJinHuaPanel.prototype.onTouchCloseSecondPanel = function () {
        this.grpSecondPanel.visible = false;
    };
    ZhaJinHuaPanel.prototype.onTouchRedBox = function () {
        PanelManage.openRedBox(1, 1);
    };
    ZhaJinHuaPanel.prototype.operateBoxComplete = function () {
        lcp.LListener.getInstance().dispatchEvent(new lcp.LEvent(EventData.UPDATE_MAIN));
    };
    //只更新玩家的金币
    ZhaJinHuaPanel.prototype.updateDataGold = function () {
        EffectUtils.numEffect(this.titleLabMoney, parseInt(GlobalData.user.gold));
    };
    ZhaJinHuaPanel.prototype.dispose = function () {
    ...
    ZhaJinHuaPanel.prototype.setTouchEnabled = function () {
        QuickManage.setTouchEnabled(this);
    };
    return ZhaJinHuaPanel;
}(eui.Component));
__reflect(ZhaJinHuaPanel.prototype, "ZhaJinHuaPanel", ["fany.IDispose"]);

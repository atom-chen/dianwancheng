...
var GameListen = (function () {
    ...
    GameListen.prototype.setFruit = function () {
    ...
    GameListen.prototype.setNiuniu = function () {
        fany.SocketManage.pomelo.on(MessageData.NIUNIU_EVENT, function (data) {
            if (PanelManage.niuniu) {
                PanelManage.niuniu.onMsgListen(data);
            }
        }); //斗牛监听事件
    };
    GameListen.prototype.setZjh = function () {
        fany.SocketManage.pomelo.on(MessageData.GOLDEN_EVENT, function (data) {
            if (PanelManage.zhajinhua) {
                PanelManage.zhajinhua.onMsgListen(data);
            }
        }); //炸金花消息推送
    };
    GameListen.prototype.setPk = function () {
        fany.SocketManage.pomelo.on(MessageData.PK_EVENT, function (data) {
            if (PanelManage.pk) {
   ...
   * @param index
   */
    GameListen.prototype.manageOn = function (index, data) {
        switch (index) {
            case 2:
    ...
    GameListen.prototype.manageOnFruit = function (index, data) {
        switch (index) {
            case 2:
    ...
    GameListen.prototype.manageOnClown = function (index, data) {
  ...
  * @param index
  */
    GameListen.prototype.manageOnDdz = function (index, data) {
        //TipsManage.showTips(index + "==" + JSON.stringify(data))
        switch (index) {
            case 1:
                if (PanelManage.ddz) {
...
GameListen.instance = null;
__reflect(GameListen.prototype, "GameListen");
